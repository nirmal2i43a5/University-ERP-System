...
class CourseForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(Row(Column("course_name",
                                               css_class="form-group col-md-6 mb-0"),
                                        Column("course_code",
                                               css_class="form-group col-md-6 mb-0"),
                                        css_class="form-row",
                                        ),
                                    Row(Column("course_description",
                                               css_class="form-group col-md-6 mb-0"),
                                        css_class="form-row",
                                        ),
                                    )
...
class AddSystemAdminForm(forms.ModelForm):
    ...
    user_type = forms.ModelChoiceField(
        empty_label="Select Admin Group ",
        queryset=Group.objects.exclude(
            name__in=["Student", "Teacher", "Parent", "Procurement", "Finance"]
        ),
    )
...
class EditCustomUserForm(forms.ModelForm):
    ...
    # password = forms.CharField(required = False, widget=forms.PasswordInput(
    # attrs={"placeholder": "Fill This Only If You Want To Change
    # Password",}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                ...
                Row(
                    # Column(HTML('<button type="button" class="btn
                    # btn-primary" style="margin-top: 30px;"
                    # data-toggle="modal"
            ...
            Row(
                ...
                HTML(
                    '<button class="btn btn-success ml-2" name = "extrauser_submit" type="submit">Save</button>&nbsp;'
                ),
            ),
        )
...
class StaffForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(Row(Column("courses",
