    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(blank=True, null=True, upload_to="parent_images"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                through="student_management_app.SubjectTeacher",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("Running", "Running"), ("In Active", "In Active")],
                        max_length=50,
                    ),
                ),
                ...
                (
                    "barcode",
                    models.ImageField(blank=True, upload_to="student_barcodes/"),
                ),
                (
                    "register_no",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="student_management_app.studentgroup",
                    ),
                ),
                (
                    "guardian",
                    models.ForeignKey(
                        ...
                        to="student_management_app.parent",
                    ),
                ),
                (
                    "optional_subject",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "courses",
                    models.ManyToManyField(
                        max_length=100, to="student_management_app.CourseCategory"
                    ),
                ),
                (
                    "department",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="student_management_app.department",
                    ),
                ),
                (
                    "staff_user",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                through="student_management_app.SemesterTeacher",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subject_id",
                    models.CharField(
                        blank=True, default="XXX", max_length=50, null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now_add=True)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="student_management_app.branch",
                    ),
                ),
                (
                    "extra_user",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="student_management_app.extrauser",
                    ),
                ),
                (
                    "parent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "background_image",
                    models.ImageField(
                        blank=True, upload_to="certificate_template_background"
                    ),
                ),
                (
                    "student",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("subject", "section"), name="unique_subject_teacher_section"
            ),
        ),
    ]
