...
urlpatterns = [
      ...
      path('restore_inactive_student/<pk>/', student_views.restore_inactive_students, name = "restore_inactive_students"),
      path('inactive_students/', student_views.inactive_students, name = "inactive_students"),
         path('student_bulk_photo_upload/', student_views.student_bulk_photo_upload, name = "student_bulk_photo_upload"),
      path('make_student_inactive/<pk>/', student_views.make_student_inactive, name = "make_student_inactive"),
