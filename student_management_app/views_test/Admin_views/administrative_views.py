...
def add_manage_session_year(request):
    ...
    if request.method == "POST":
        ...
        try:
            if form.is_valid():
                ...
                # return
                # render(request,'admin_templates/administrator/sessions/add_session.html',
                # context)
    ...
    return render(
        request,
        "admin_templates/administrator/sessions/add_session.html",
        context)
...
def edit_session(request, session_id):
    ...
    return render(
        request,
        "admin_templates/administrator/sessions/edit_session.html",
        context)
...
def add_manage_group(request):
    ...
    return render(
        request,
        "admin_templates/administrator/students_groups/manage_group.html",
        context,
    )
...
def edit_group(request, group_id):
    ...
    return render(
        request,
        "admin_templates/administrator/students_groups/edit_group.html",
        context,
    )
...
def add_complain(request):
    ...
    return render(
        request,
        "admin_templates/administrator/complains/add_complain.html",
        context)
...
def manage_complain(request):
    ...
    return render(
        request,
        "admin_templates/administrator/complains/manage_complain.html",
        context)
...
def edit_complain(request, complain_id):
    ...
    return render(
        request,
        "admin_templates/administrator/complains/edit_complain.html",
        context)
...
def add_sociallink(request):
    ...
    return render(
        request,
        "admin_templates/administrator/social_links/add_sociallink.html",
        context,
    )
...
def edit_sociallink(request, sociallink_id):
    ...
    return render(
        request,
        "admin_templates/administrator/social_links/edit_sociallink.html",
        context,
    )
...
def manage_sociallink(request):
    ...
    return render(
        request,
        "admin_templates/administrator/social_links/manage_sociallink.html",
        context,
    )
