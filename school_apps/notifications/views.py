...
def show_notification(request):
    ...
    context = {"notifications": notifications, "title": "Notifications"}
    return render(request, "notifications/notifications.html", context)


def update_notification(
    request,
):  # ajax call when click on notification icon and make notification zero after is_seen = True
...
@permission_required("notifications.delete_notifications",
