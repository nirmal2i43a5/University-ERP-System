...
class RoleForm(PermissionField):
    name = forms.CharField(widget=forms.TextInput(
        attrs={"placeholder": "Enter Respective Role Name"}))
...
# This is the form that is populated when i search permision for
# respective user in manage_permission--- we edit permission for
# particular group
