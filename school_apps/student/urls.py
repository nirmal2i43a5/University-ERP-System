...
urlpatterns = [
    ...
    path(
        "print_results/<str:form_id>/",
        views.printresults,
        name="printresults"),
    path("print_admitcard/", views.printadmitcard, name="printadmitcard"),
    path(
        "printapplicationform/", views.printapplicationform, name="printapplicationform"
    ),
    path(
        "student_application/",
    ...
    path(
        "ajax/confirmexamAjax/",
        views.confirmexamAjax,
        name="confirmexamAjax"),
    ...
    path(
        "parent/checkscore/",
        views.parent_checkscore,
        name="parent_checkscore"),
    path(
        "ajax/returnExamslist/",
        views.returnExamslist,
        name="returnExamslist"),
    path(
        "student_autocomplete/",
        views.student_ajax_autocomplete,
        name="student_ajax_autocomplete",
    ),
]
