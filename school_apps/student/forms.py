...
class StudentForm(forms.ModelForm):
    ...
    stu_id = forms.CharField(label='Student Id.',required = True, widget=forms.TextInput(
        attrs={"class": "form-control", "placeholder": " Enter Matrix Number", }))
    roll_no = forms.CharField(label='Roll No.',required=False, widget=forms.TextInput(
