...
class StudentForm(forms.ModelForm):
    ...
    # empty_label="-----Please Select Your Parent Name----- ",
    ...
    status = forms.ChoiceField(
        choices=status_choices, widget=forms.RadioSelect(), initial="Running"
    )
    shift = forms.ChoiceField(
        choices=shift, widget=forms.RadioSelect(), initial="Morning"
    )
    ...
    previous_school_name = forms.CharField(
        required=False,
        label="Past School/College",
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": " Enter Your Past School Name",
            }
        ),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(Row(Column("course_category",
