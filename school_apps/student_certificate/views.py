...
from student_management_app.models import Student, CertificateTemplate
...
def add_certificate_template(request):
    ...
    return render(
        request,
        "certificate_templates/add_certificate.html",
        context)
...
def edit_certificate_template(request, certificate_template_id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return redirect(
                "certificate:edit_certificate_template",
                certificate_template_id)

    context = {"form": form, "title": "Certificate"}
    return render(
        request,
        "certificate_templates/edit_certificate.html",
        context)
...
def manage_certificate_template(request):
    ...
    return render(
        request,
        "certificate_templates/manage_certificate.html",
        context)
...
def print_character_certificate(request, certificate_id, student_id):
    ...
    return render(
        request,
        "certificate_templates/character_certificate.html",
        context)
