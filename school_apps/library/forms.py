...
class CategoryForm(forms.Form):
    category = forms.ModelChoiceField(
        widget=forms.Select(attrs={}), queryset=Category.objects.all()
    )
...
class AddMemberForm(forms.ModelForm):
    ...
    # empty_label="Select User Type ", queryset=Group.objects.exclude(name__in
    # = ['Parent','Super-Admin','Bachelor-Admin','Master-Admin','Admin']))
