...
class BookIssue(models.Model):
    ...
    issue_member = models.ForeignKey(
...
class BookReturn(models.Model):
    book_issue = models.ForeignKey(
        BookIssue, on_delete=models.CASCADE, related_name="bookreturns"
    )
...
class BookRenew(models.Model):
    book_issue = models.ForeignKey(
        BookIssue, on_delete=models.CASCADE, related_name="bookrenew"
    )
...
class LibraryFine(models.Model):
    fine_member = models.ForeignKey(
        LibraryMemberProfile, on_delete=models.CASCADE, blank=True, null=True
    )
    book_issue = models.ForeignKey(
        BookIssue, on_delete=models.CASCADE, blank=True, null=True
    )
...
class Barcode(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        isbn = ISBN(
            f"{self.country_id}{self.manufacturer_id}{self.product_id}",
            writer=ImageWriter(),
        )
        buffer = BytesIO()
        isbn.write(buffer)
