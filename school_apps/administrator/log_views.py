...
def complain_log(request):
    ...
    return render(request,'administrator/loghistory/individuals/complain.html',context)
...
def certificate_log(request):
    ...
    return render(request,'administrator/loghistory/individuals/certificate.html',context)
