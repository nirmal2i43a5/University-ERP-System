...
urlpatterns = [
    ...
    path("exportcsv/<str:pk>", views.exportcsv, name="exportcsv"),
    ...
    path(
        "teacher/students/",
        student_view_by_teacher,
        name="student_view_by_teacher"),
    path(
        "attendance/home/",
        teacher_attendance_home,
        name="teacher_attendance_home"),
