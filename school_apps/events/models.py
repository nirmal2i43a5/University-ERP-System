...
class Event(models.Model):
    ...
    event_day = models.CharField(
        _("Event Date"),
        max_length=20)  # default=date.today()
    ...
    def save(self, *args, **kwargs):
        ...
        english_year_digit, english_month_digit, english_day_digit = get_nepali_digit(
            nep_date[0], nep_date[1], nep_date[2])
