...
# I am making this form just for solving name issue for guardian/full_name
# in parent.If i dont use this then i cannot change label of full_name
# with guardian namae
...
class ParentForm(forms.ModelForm):
    ...
    local_guardian_name = forms.CharField(
        required=False,
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
    ...
    father_phone = forms.CharField(
        label="Parent Main Contact",
        required=False,
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": " Enter Parent Main Contact",
            }
        ),
    )
    mother_phone = forms.CharField(
        label="Parent Additional Contact",
        required=False,
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": " Enter  Parent Additional Contact",
            }
        ),
    )
    local_guardian_phone = forms.CharField(
        required=False,
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_tag = False
        self.helper.layout = Layout(Row(Column("father_phone",
                                               css_class="form-group col-md-6 mb-0"),
                                        Column("mother_phone",
                                               css_class="form-group col-md-6 mb-0"),
                                        css_class="form-row",
                                        ),
                                    Row(Column("father_name",
                                               css_class="form-group col-md-6 mb-0"),
                                        Column("mother_name",
                                        css_class="form-group col-md-6 mb-0"),
                                        css_class="form-row",
                                        ),
                                    Row(Column("local_guardian_name",
                                               css_class="form-group col-md-6 mb-0"),
                                        Column("local_guardian_phone",
                                               css_class="form-group col-md-6 mb-0"),
                                        css_class="form-row",
                                        ),
                                    Row(HTML('<a class="btn btn-danger" href="{% url "dashboard" %}">Back</a>'),
