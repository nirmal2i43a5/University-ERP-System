...
class CustomSetPasswordForm(forms.Form):
    ...
    role=forms.ModelChoiceField(empty_label = 'Select Role For Changing Password', label = 'User Role',queryset=Group.objects.all())
    user = forms.ModelChoiceField(empty_label = 'Select User For Changing Password',queryset=CustomUser.objects.all())
