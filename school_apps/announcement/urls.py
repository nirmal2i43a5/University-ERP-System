...
from . import views
from school_apps.announcement.log_views import (
    notice_log,
    delete_notice_log,
    event_log,
    delete_event_log,
    all_announcement_log,
    delete_all_log,
)
...
urlpatterns = [
    ...
    path("delete_holiday/<str:holiday_id>/",
         delete_holiday, name="delete_holiday"),
    ...
    path(
        "announcement-management/", manage_notice, name="announcement-management"
    ),  # for dynamic sidebar
]
