...
def notice_log(request):
    ...
    return render(request,'announcements/loghistory/individuals/notice.html',context)
...
def event_log(request):
    ...
    return render(request,'announcements/loghistory/individuals/event.html',context)
