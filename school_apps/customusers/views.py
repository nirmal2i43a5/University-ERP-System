...
@permission_required('student_management_app.view_customuser', raise_exception=True)
...
@permission_required('student_management_app.change_customuser', raise_exception=True)
