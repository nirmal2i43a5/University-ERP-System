...
urlpatterns = [
    ...
    path("edit_complain/<str:complain_id>/",
         edit_complain, name="edit_complain"),
    path("delete_complain/<str:complain_id>/",
         delete_complain, name="delete_complain"),
    path(
        "complain-management/", complain_home, name="complain-management"
    ),  # for dynamic sidebar
]
