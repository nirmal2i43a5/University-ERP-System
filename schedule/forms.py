...
class EventForm(SpanForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(Row(Column("title",
                                    ...
                                    Row(Column("start",
                                               css_class="form-group col-md-6 mt-4 mb-0"),
                                        Column("end",
                                        css_class="form-group col-md-6 mt-4 mb-0"),
                                        ),
                                    ...
                                    Row(HTML('<a class="btn btn-danger text-white" href="{% url "manage_event" %}">Back</a>'),
